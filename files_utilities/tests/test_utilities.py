...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("John Són - 123", "john_són_123"),
        # ("Test Revisión - 123", "john_són_123"), these tests are failing
        # ("teórica Anónimo - 123", "teórica_anónimo_123"),
        (
...
# run test with: pytest -s -v files_utilities/tests/test_utilities.py
